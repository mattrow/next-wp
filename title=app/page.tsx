...
import { Crown, Medal, Link as ExternalLink, Trophy, Star, Award, Heart, MessageCircle, Settings} from "lucide-react";
...
const apps = [
  {
    ...
    description: "The most advanced AI companion with deep emotional intelligence and natural conversations.",
    categories: {
      personality: 9.5,
      features: 9.0,
      customization: 9.8
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 flex flex-col justify-between">
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        >
                          <div className="flex flex-col items-center">
                            ...
                            <span className="mt-2 text-lg font-bold text-white">
                              {app.categories[feature.scoreKey as keyof typeof app.categories]}
                            </span>
                          </div>
                        </div>
                      ))}
                      ...
                      <div className="flex-1 rounded-lg p-3 bg-gradient-to-br from-purple-500 to-pink-500">
                        <div className="flex flex-col items-center">
                  ...
                  <div className="w-full md:w-1/4 flex flex-col justify-center items-center">
                    <div className="w-full px-4 flex flex-col gap-2">
                      <Link
                        href="#"
                        className="flex items-center justify-center gap-2 py-2 px-4 rounded-lg bg-purple-500 hover:bg-purple-600 text-white text-sm transition-all transform hover:scale-105"
                      >
                        Visit Site
                      ...
                      <Link
                        href="#"
                        className="flex items-center justify-center gap-2 py-2 px-4 rounded-lg bg-gray-700 hover:bg-gray-600 text-white text-sm transition-all transform hover:scale-105"
                      >
                        Read Review
